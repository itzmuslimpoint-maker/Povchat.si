...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_50%,rgba(168,85,247,0.08),transparent_70%)]" />
      <div className="absolute top-20 left-10 w-72 h-72 bg-accent-pink/5 rounded-full blur-3xl" />
      ...
      >
        ...
        <h1 className="font-display text-2xl font-black text-center mb-2">Welcome Back</h1>
        ...
        <p className="text-center text-sm text-text-secondary mt-6">
          ...
          <Link to="/signup" className="text-accent-purple hover:text-accent-pink font-semibold transition-colors">
            Sign Up Free
          </Link>
        </p>
      </motion.div>
